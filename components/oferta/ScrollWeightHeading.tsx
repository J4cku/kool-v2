...
export default function ScrollWeightHeading({
  ...
  useEffect(() => {
    ...
    if (!el) return;
    // Fire once the heading enters the top ~third of the viewport, then latch.
  ...
  return (
    ...
    >
      <span
        aria-hidden="true"
        className="[grid-area:1/1] font-[500] transition-opacity duration-200 ease-out"
      ...
      <span
        aria-hidden="true"
        className="[grid-area:1/1] font-[700] transition-opacity duration-200 ease-out"
