    ...
    <div className="w-full py-10 md:py-14">
      {rows.map((row, index) => (
        <div key={index}>
          ...
          <div className="flex items-baseline py-3.5 gap-8 px-5 md:px-10 lg:px-12">
            <span className="text-[12px] md:text-[13px] font-[400] uppercase tracking-[0.15em] text-dark w-[180px] shrink-0">
              {row.label}
            </span>
            <span className="text-[14px] md:text-[15px] font-[300] text-dark">
              {row.value}
            </span>
          </div>
        </div>
